...
"[project]/node_modules/nuqs/dist/chunk-6YKAEXDW.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function safeParse(parser, value, key) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["warn"])("[nuqs] Error while parsing value `%s`: %O" + (key ? " (for key `%s`)" : ""), value, error2, key);
        return null;
    }
}
...
function enqueueQueryStringUpdate(key, value, serialize, options) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs queue] Enqueueing %s=%s %O", key, serializedOrNull, options);
    ...
    if (flushPromiseCache === null) {
        flushPromiseCache = new Promise((resolve, reject)=>{
            if (!Number.isFinite(queueOptions.throttleMs)) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs queue] Skipping flush due to throttleMs=Infinity");
            ...
            function runOnNextTick() {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs queue] Scheduling flush in %f ms. Throttled at %f ms", flushInMs, throttleMs);
                if (flushInMs === 0) {
                    flushNow();
                } else {
...
function flushUpdateQueue({ updateUrl, getSearchParamsSnapshot }) {
    ...
    resetQueue();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs queue] Flushing queue %O with options %O", items, options);
    ...
    try {
        ...
        console.error((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["error"])(429), items.map(([key])=>key).join(), err);
        return [
            search,
            err
        ];
...
"[project]/node_modules/nuqs/dist/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/nuqs/dist/chunk-6YKAEXDW.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/nuqs/dist/chunk-5WWTJYGR.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
...
function createParser(parser) {
    function parseServerSideNullable(value) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeParse"])(parser.parse, str);
    }
    return {
        eq: (a, b)=>a === b,
        ...parser,
...
function parseAsArrayOf(itemParser, separator = ",") {
    ...
    return createParser({
        parse: (query)=>{
            ...
            return query.split(separator).map((item, index)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeParse"])(itemParser.parse, item.replaceAll(encodedSeparator, separator), `[${index}]`)).filter((value)=>value !== null && value !== undefined);
        },
...
function createSerializer(parsers, { clearOnDefault = true, urlKeys = {} } = {}) {
    function serialize(arg1BaseOrValues, arg2values = {}) {
        ...
        if (values === null) {
            ...
            return base + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["renderQueryString"])(search);
        }
        for(const key in parsers){
...
function useQueryState(key, { history = "replace", shallow = true, scroll = false, throttleMs = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FLUSH_RATE_LIMIT_MS"], parse = (x)=>x, serialize = String, eq = (a, b)=>a === b, defaultValue = undefined, clearOnDefault = true, startTransition } = {
    history: "replace",
    scroll: false,
    shallow: true,
    throttleMs: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FLUSH_RATE_LIMIT_MS"],
    parse: (x)=>x,
    serialize: String,
    eq: (a, b)=>a === b,
    clearOnDefault: true,
    ...
    const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdapter"])();
    const initialSearchParams = adapter.searchParams;
    const queryRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(initialSearchParams?.get(key) ?? null);
    const [internalState, setInternalState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        const queuedQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getQueuedValue"])(key);
        const query = queuedQuery === undefined ? initialSearchParams?.get(key) ?? null : queuedQuery;
        return query === null ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeParse"])(parse, query, key);
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs `%s`] render - state: %O, iSP: %s", key, internalState, initialSearchParams?.get(key) ?? null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const query = initialSearchParams?.get(key) ?? null;
        if (query === queryRef.current) {
            return;
        }
        const state = query === null ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeParse"])(parse, query, key);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs `%s`] syncFromUseSearchParams %O", key, state);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        function updateInternalState({ state, query }) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs `%s`] updateInternalState %O", key, state);
            stateRef.current = state;
            queryRef.current = query;
            setInternalState(state);
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs `%s`] subscribing to sync", key);
        emitter.on(key, updateInternalState);
        return ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuqs `%s`] unsubscribing from sync", key);
            emitter.off(key, updateInternalState);
        };
    }, [
        key
    ]);
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((stateUpdater, options = {})=>{
        ...
        const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enqueueQueryStringUpdate"])(key, newValue, serialize, {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scheduleFlushToURL"])(adapter);
    }, [
        key,
        history,
        shallow,
...
function useQueryStates(keyMap, { history = "replace", scroll = false, shallow = true, throttleMs = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FLUSH_RATE_LIMIT_MS"], clearOnDefault = true, startTransition, urlKeys = defaultUrlKeys } = {}) {
    ...
    const stateRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(internalState);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuq+ `%s`] render - state: %O, iSP: %s", stateKeys, internalState, initialSearchParams);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        function updateInternalState(state) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuq+ `%s`] updateInternalState %O", stateKeys, state);
            stateRef.current = state;
            setInternalState(state);
        }
        const handlers = Object.keys(keyMap).reduce((handlers2, stateKey)=>{
            handlers2[stateKey] = ({ state, query })=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuq+ `%s`] Cross-hook key sync %s: %O (default: %O). Resolved: %O", stateKeys, urlKey, state, defaultValue, stateRef.current);
        ...
        for (const stateKey of Object.keys(keyMap)){
            const urlKey = resolvedUrlKeys[stateKey];
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuq+ `%s`] Subscribing to sync for `%s`", stateKeys, urlKey);
            emitter.on(urlKey, handlers[stateKey]);
        }
        return ()=>{
            for (const stateKey of Object.keys(keyMap)){
                const urlKey = resolvedUrlKeys[stateKey];
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuq+ `%s`] Unsubscribing to sync for `%s`", stateKeys, urlKey);
    ...
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((stateUpdater, callOptions = {})=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$5WWTJYGR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debug"])("[nuq+ `%s`] setState: %O", stateKeys, newState);
        for (let [stateKey, value] of Object.entries(newState)){
            ...
            const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enqueueQueryStringUpdate"])(urlKey, value, parser.serialize ?? String, {
    ...
    const outputState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>applyDefaultValues(internalState, defaultValues), [
        internalState,
        defaultValues
    ]);
    return [
...
function parseMap(keyMap, urlKeys, searchParams, cachedQuery, cachedState) {
    ...
    const state = Object.keys(keyMap).reduce((out, stateKey)=>{
        ...
        const queuedQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getQueuedValue"])(urlKey);
        ...
        hasChanged = true;
        const value = query === null ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nuqs$2f$dist$2f$chunk$2d$6YKAEXDW$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeParse"])(parse, query, stateKey);
...
"[project]/node_modules/mitt/dist/mitt.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_64f64dcf._.js.map